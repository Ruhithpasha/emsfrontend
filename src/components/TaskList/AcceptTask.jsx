...
const AcceptTask = ({data}) => {
  ...
  return (
    <div className=' flex-shrink-0 w-[333.5px] h-full bg-blue-500 rounded-lg p-8 '>
    ...
    <button className="px-4 py-1 text-sm mt-2 mr-2 text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
            Accept Task
        </button>
